...
from PyQt6.QtWidgets import QInputDialog, QLineEdit, QMessageBox, QPushButton
...
class MPushButton(QPushButton):
    ...
    def longReleased(self):
        ...
        if 500 < self.i_PressCount < 1000:
            ...
            text = QInputDialog.getText(self.motherWidget, "我只是打酱油的~", "input CMD + DATA (BB0101)",
            ...
            # NOT WORK NOW
            ans = QMessageBox.question(self.motherWidget, "tip", "delete button ?",
