from PyQt6.QtCore import Qt, pyqtSlot, QFile, QTextStream
from PyQt6.QtGui import QDragEnterEvent
from PyQt6.QtWidgets import QDockWidget, QTextEdit, QWidget, QMainWindow, QVBoxLayout
...
class govee_mqtt_log:
    ...
    def form_init(self):
        ...
        self.in_edit = MTextEdit(self.in_dock)
        ...
        self.in_edit.signal_fileDragInput.connect(lambda dir: self.file_input(dir))

        self.out_dock = QDockWidget()
        self.out_edit = MTextEdit(self.out_dock)
